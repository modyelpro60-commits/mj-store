...
export default function OrdersPage() {
  ...
  // Group orders by section, sorted newest first
    ...
    >
      ...
      {loading ? (
        ...
        <motion.section
          ...
          className="rounded-[2rem] border border-white/10 bg-zinc-950/75 p-6 shadow-[0_20px_60px_rgba(0,0,0,0.28)]"
        >
          <div className="mt-2 rounded-[1.5rem] border border-white/10 bg-white/5 p-8 text-zinc-400">
            No orders found.
          </div>
        </motion.section>
      ) : (
                    ...
                    <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
                      <div className="grid gap-2">
                        <div className="flex flex-wrap items-center gap-3">
                          ...
                          <span
                            className={`inline-flex items-center rounded-full border px-4 py-1.5 text-sm font-semibold ${statusBadgeClass(statusValue)}`}
                          >
                            {statusValue}
                          </span>
                        </div>
      ...
      {pendingDeleteId !== null ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="rounded-[2rem] border border-red-500/20 bg-red-500/10 p-6 text-center shadow-[0_20px_60px_rgba(0,0,0,0.28)]">
            <h3 className="mb-4 text-lg font-bold text-white">Are you sure?</h3>
            ...
            <div className="flex gap-4 justify-center">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-red-600 px-6 py-2 font-bold text-white transition-all duration-300 hover:bg-red-700 disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={savingId === pendingDeleteId}
                className="inline-flex items-center gap-2 rounded-xl bg-zinc-700 px-6 py-2 font-bold text-zinc-300 transition-all duration-300 hover:bg-zinc-600 disabled:opacity-50"
              >
                Cancel
              </button>
            </div>
