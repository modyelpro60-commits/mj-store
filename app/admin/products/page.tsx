              ...
              >
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl border border-red-400/20 bg-red-500/10 px-4 py-3 font-semibold text-red-100 transition-all duration-300 hover:bg-red-500/20"
                  >
                    <Trash2 className="h-4 w-4" />
                    Delete
                  </button>
